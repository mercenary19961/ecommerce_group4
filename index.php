                    ...
                    <ul id="navbar" class="navbar-nav text-uppercase justify-content-end align-items-center flex-grow-1 pe-3">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="#mobile-products" class="dropdown-item">IPhones</a>
                                </li>
                                <li>
                                    <a href="#ipad-products" class="dropdown-item">Ipads</a>
                                </li>
                                <li>
                                    <a href="#mac-products" class="dropdown-item">MAC</a>
                                </li>
                                <li>
          ...
          <div class="swiper-slide">
            <div class="container">
              <div class="row d-flex align-items-center">
                ...
                <div class="col-md-5">
                  <div class="image-holder">
                    <img src="images/mac.png" alt="banner" style="position: relative; top:12vh;right:5vh">
                  </div>
                </div>
              </div>
            </div>
